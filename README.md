...
- #### 문제 발생
  메인 화면에서 사용자 이미지가 좌우로 늘어나는 현상이 있었습니다.

- #### 문제 이유
  <img width="245" alt="이미지오류" src="https://github.com/user-attachments/assets/38f10262-86ab-44d4-8392-c279e50c5a4d">
  <br/>인스펙션에서 이미지를 클릭해보니 이미지에 설정해둔 width가 적용되지 않고, video-mixin div 안의 img 태그에 설정해둔 width가 적용되고 있었습니다.

- #### 해결 방법
  video-mixin div 안의 img 태그에 새로운 클래스 네임을 주어 문제를 해결하였습니다.
